  ...
  <div class="form">
      ...
      <div class="tab-content">
        <div id="signup">   
          ...
          <div class="field-wrap">
                    ...
                    <td><input type="email" name="email" class="textInput" placeholder="abc@xyz.com" /></td>
                   </tr>
                   <p id="demo"></p>
          </div>
     ...
     <tr>
          ...
          <td><input type="password" name="password2" class="textInput"  placeholder="Retype-Password" minlength="6" /></td>
                     ...
                     <tr>
                    <td></td>
                   <td><input type="submit" name="register_btn" value="Register" class="button button-block" onclick="return validate(this)" ></td>
                  </tr>
